...
const { ValidationError, EntryNotFound } = require('../designers/designers');
...
module.exports.postusers = (req, res, next) => {
  ...
  if (password.length < 8) { return new ValidationError('Длина пароля долна быть больше 8 символов!'); }
...
module.exports.getusersid = (req, res, next) => {
  users.findById(req.params.id)
    ...
    .catch(() => next(new EntryNotFound('Данный пользователь не был найден')));
};
